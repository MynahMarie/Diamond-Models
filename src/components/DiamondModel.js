    ...
    return (
      ...
      >
        ...
        <View style={styles.row}>
          <TextInput
          ref={ref => { this._box1 = ref }}
          placeholder={'Start Here'}
          multiline={true}
          onFocus={() => this._onFocus(0)}
          onBlur={() => this._onBlur(0)}
          style={[styles.inputBox, this.state.inputs[0].isFocused ? {borderWidth: 2} : '']}
        ...
        <View style={styles.row}>
          ...
          style={[styles.inputBox, this.state.inputs[2].isFocused ? {borderWidth: 2} : '']}
          returnKeyType="next"
          ...
          style={[styles.inputBox, this.state.inputs[1].isFocused ? {borderWidth: 2} : '']}
          returnKeyType="next"
        ...
        <View behavior="padding" style={styles.row}>
          ...
          style={[styles.inputBox, this.state.inputs[6].isFocused ? {borderWidth: 2} : '']}
          returnKeyType="next"
          ...
          style={[styles.inputBox, this.state.inputs[5].isFocused ? {borderWidth: 2} : '']}
          returnKeyType="next"
          ...
          style={[styles.inputBox, this.state.inputs[4].isFocused ? {borderWidth: 2} : '']}
          returnKeyType="next"
          ...
          style={[styles.inputBox, this.state.inputs[3].isFocused ? {borderWidth: 2} : '']}
          returnKeyType="next"
        ...
        <View behavior="padding" style={styles.row}>
          ...
          style={[styles.inputBox, this.state.inputs[8].isFocused ? {borderWidth: 2} : '']}
          returnKeyType="next"
          ...
          style={[styles.inputBox, this.state.inputs[7].isFocused ? {borderWidth: 2} : '']}
          returnKeyType="next"
        ...
        <View behavior="padding" style={styles.row}>
          ...
          style={[styles.inputBox, this.state.inputs[9].isFocused ? {borderWidth: 2} : '']}
          returnKeyType="done"
